...
public class VentanaGestionEmpleadoLogistica extends javax.swing.JFrame {
     ...
     */
    public VentanaGestionEmpleadoLogistica(AdministradorAerolinea adminAerolinea) {
        initComponents();
        this.administradorAerolinea = adminAerolinea; 
        modelo = (DefaultTableModel)tabla.getModel();
        this.controlador = new ControladorVentanaGestionEmpleadoLogistica();
        actualizarTabla();
    }
    ...
    private void actualizarTabla(){
        Aerolinea aerolinea = controlador.buscarAerolineaCodigo(administradorAerolinea.getIdentificacion());
        LSE<EmpleadoLogistica> capitanes = controlador.conseguirEmpleados(aerolinea);
        try{
            for (int i = 0; i < 3 ; i++) {
