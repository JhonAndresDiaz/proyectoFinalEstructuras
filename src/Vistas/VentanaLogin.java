...
public class VentanaLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIngresarMouseClicked
        if (txtCorreo.getText().isEmpty() || txtContrasenia.getText().isEmpty()) {
            ...
            Aerolinea aerolineaAdmin = controlador.buscarAeroAdminAerolinea(correo);
            Aerolinea aerolineaEmpleado = controlador.buscarAeroEmpleadoLog(correo);
            Aerolinea aerolineaCapitanes = controlador.buscarAeroCapitanVuelo(correo);
            ...
            switch (rol){
                ...
                if (persona.getContrasenia().equals(contrasenia)) {
                    this.dispose();
                    JFrame v2 = new VentanaMenuPrincipalAdAerolinea((AdministradorAerolinea) persona, aerolineaAdmin);
                    v2.setVisible(true);
                    return;
                }
                break;
                ...
                if (persona.getContrasenia().equals(contrasenia)) {
                    this.dispose();
                    JFrame v2 = new VentanaMenuPrincipalEmpleadoLogistica((EmpleadoLogistica) persona, aerolineaEmpleado);
                    v2.setVisible(true);
                    return;
                }
                break;
                ...
                if (persona.getContrasenia().equals(contrasenia)) {
                    this.dispose();
                    JFrame v2 = new VentanaMenuPrincipalCapitanVuelo((CapitanVuelo) persona, aerolineaCapitanes);
                    v2.setVisible(true);
                    return;
                }
                break;
